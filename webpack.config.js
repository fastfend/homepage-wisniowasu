...
module.exports = {
  ...
  module: {
    rules: [
      ...
      },
      {
        ...
        include: [
          path.resolve(__dirname, "./src/img/projects")
        ],
        use: [
          {
  ...
  plugins: [
    ...
    new HtmlWebPackPlugin({
      ...
      desc: "Poznaj samorząd uczniowski z Technikum Mechatronicnego nr 1 w Warszawie, którego połączyła chęć zmian. Zobacz jaki jest samorząd na Wiśniowej 56!",
