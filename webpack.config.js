...
module.exports = {
  ...
  entry: {
    ...
    harmonogram: './src/views/templates/wifi/harmonogram.js',
    details: './src/views/templates/wifi/details.js',
    wifi_contact: './src/views/templates/wifi/contact.js',
  },
  output: {
